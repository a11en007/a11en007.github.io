        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20">
          <div className="text-center">
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              <span className="word-animate" data-delay="0">Welcome</span>
              <span className="word-animate" data-delay="300">to</span>
              <span className="word-animate" data-delay="600">my</span>
              <span className="word-animate" data-delay="900">portfolio</span>
            </h2>
          ...
          <div className="text-center max-w-5xl mx-auto relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
              <div className="mb-4 md:mb-6">
                <span className="word-animate" data-delay="1200">I'm</span>
                <span className="word-animate" data-delay="1400">Allen</span>
                <span className="word-animate" data-delay="1600">Jose</span>
                <span className="word-animate" data-delay="1800">James</span>
              </div>
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide">
                <span className="word-animate" data-delay="2000">Cybersecurity</span>
                <span className="word-animate" data-delay="2200">Analyst</span>
                <span className="word-animate" data-delay="2400">&</span>
                <span className="word-animate" data-delay="2600">Music</span>
                <span className="word-animate" data-delay="2800">Producer</span>
              </div>
            </h1>
          ...
          <div className="text-center">
            ...
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              ...
              <span className="word-animate" data-delay="3400">to</span>
              <span className="word-animate" data-delay="3600">explore</span>
            </h2>
